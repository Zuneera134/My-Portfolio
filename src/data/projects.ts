...
export const projects: Project[] = [
  {
    ...
    description:
      "A production-grade full-stack platform for a pizza & burger shop, built with Insiscos. A monorepo combining a Next.js + TypeScript frontend, a Node.js/Express backend with MongoDB, and a Flutter mobile app. Ships with a complete CI/CD pipeline — staging & production deployments, automated security scanning (SAST, secret and container scans), safe database migrations, and instant incident-response rollback for zero-downtime release.",
  ...
  },
  {
    ...
    description:
      "An AI-centric Human Resource Management System, built live as a hands-on student walkthrough at TechNest (led by HuzaifaSafdar, with Insiscos). Combines full-stack HR operations — employee management, attendance, leave and approval workflows — with AI-assisted features such as resume parsing and candidate screening to streamline the hiring pipeline.",
